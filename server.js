...
app.post('/teste', (req, res) => {
    ...
    if (intentName == "kit.grande") {
        ...
        let itemEndereco = req.body.queryResult.parameters['itemEndereco']
        let quantidade = req.body.queryResult.parameters['quantidade']
        let data = req.body.queryResult.parameters['data']


        const query = 'insert into solicitations values ("'+massas+ '","'+recheio+'","'+nomeItem+'","'+nomeCliente+'","'+itemEndereco+'","'+quantidade+'","'+data+'")';
